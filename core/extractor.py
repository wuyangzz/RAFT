...
class ResidualBlockQuarter(nn.Module):
    def __init__(self, in_planes, planes, norm_fn='group', stride=1):
        super(ResidualBlockQuarter, self).__init__()
...
class BasicEncoderQuarter(nn.Module):
    ...
    def _make_layer(self, dim, stride=1):
        ...
        layer1 = ResidualBlockQuarter(self.in_planes, dim,
                               self.norm_fn, stride=stride)
        layer2 = ResidualBlockQuarter(dim, dim, self.norm_fn, stride=1)
        layers = (layer1, layer2)
