...
from update import BasicUpdateBlock, SmallUpdateBlock,BasicUpdateBlockQuarter
from extractor import BasicEncoder, SmallEncoder, BasicEncoderQuarter
from corr import CorrBlock, AlternateCorrBlock
from utils.utils import bilinear_sampler, coords_grid, upflow8, upflow4
...
class RAFT_QUarter(nn.Module):
    def __init__(self, args):
        super(RAFT_QUarter, self).__init__()
        self.args = args
